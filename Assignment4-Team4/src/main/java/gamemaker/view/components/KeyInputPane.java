...
public class KeyInputPane extends VBox {
    ...
    public KeyInputPane(){
        ...
        keyInput.setOnKeyPressed(keyEvent ->{
                keyInput.clear(); keyInput.setText(String.valueOf(keyEvent.getCode()));
    ...
    private void configureActionChoices() {
        ...
        choice1.setOnAction(e -> {
            ...
            try {
                this.getChildren().addAll(propSelectorAndInput,getSoundSelectionPane());
    ...
    public KeyInputBehaviorConfigObject export(){
        return new KeyInputBehaviorConfigObject(keyInput.getText(),inputBehavior.getText(),selectedProperty,input, path.getText());
    }
