...
//			propBackgroundColor.setValue(Constants.DEFAULT_BACKGROUND_COLOR);
    ...
    public void updateBasedOnSelectedSprite(Sprite selectedSprite, Iterator<TimeEvent> spritesTimeEvents,
        ...
        if (spritesTimeEvents != null) {
            ...
            for (Iterator<TimeEvent> it = spritesTimeEvents; it.hasNext(); ) {
                TimeEvent timeEvent = it.next();
        ...
        if (spritesCollisionEvents != null) {
            ...
            for (Iterator<CollisionEvent> it = spritesCollisionEvents; it.hasNext(); ) {
                CollisionEvent collisionEvent = it.next();
    ...
    private void configureModifyBehaviorsSelector() {
        ...
        modifyEventBtn.getItems().addAll(timeChoice, collisionChoice);
    }
    ...
    public void onSubmitEventsClicked(MouseEvent mouseEvent) {
        ...
        controller.issueCreatEventsCommand(timeBehaviorConfigObjects, keyBehaviorConfigObjects,
