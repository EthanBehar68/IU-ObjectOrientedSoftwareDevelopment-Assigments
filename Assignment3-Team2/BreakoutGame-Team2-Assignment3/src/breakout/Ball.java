...
public class Ball extends GameObject {
	...
	public Ball(int id, Drawable drawBehaviour, Color originalColor, Color color, Point2D originalPosition,
	...
	public void handleObjectCollision(GameObject collider, Point2D newPosition, Point2D newMoveDirection) {
		commandListener.receiveCommand(new BallObjectCollisionCommand(this, newPosition, newMoveDirection));
	}

	@Override
	public void handleScreenCollision(Point2D newPosition, Point2D newMoveDirection) {
		commandListener.receiveCommand(new BallScreenCollisionCommand(this, newPosition, newMoveDirection));
	}
