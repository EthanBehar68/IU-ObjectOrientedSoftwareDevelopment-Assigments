...
public class BallScreenCollisionCommand extends Command {
	...
	public BallScreenCollisionCommand() {
	}
	
	public BallScreenCollisionCommand(Ball ball, Point2D newPosition, Point2D newMoveDirection) {
		this.ball = ball;
