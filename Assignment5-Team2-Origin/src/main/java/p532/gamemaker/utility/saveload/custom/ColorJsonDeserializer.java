...
public class ColorJsonDeserializer extends StdDeserializer<Color>
{
    ...
    /**
     * Reads the properties of the colorNode and uses them to create and return a new Color POJO.
     * @param colorNode a JSON object containing properties "red", "green", and "blue"
     *                  at the top level.
     * @return a new Color object created using the properties read from the colorNode
     */
