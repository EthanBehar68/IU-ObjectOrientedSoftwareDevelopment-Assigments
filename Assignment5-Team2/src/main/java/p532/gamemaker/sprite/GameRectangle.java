...
public class GameRectangle extends Rectangle implements SpriteView
{
    ...
    {
        //Width
        propertiesBox.addDoublePropertyComponent("Width", getSpriteWidth(), Constants.PropertyType.STANDARD_PROPERTY_COMPONENT, new UpdateSpriteAdapter() {
            @Override
        ...
        //Height
        propertiesBox.addDoublePropertyComponent("Height", getSpriteHeight(), Constants.PropertyType.STANDARD_PROPERTY_COMPONENT, new UpdateSpriteAdapter() {
            @Override
            public void updateDoubleField(Double newValue) {
                super.updateDoubleField(newValue);
