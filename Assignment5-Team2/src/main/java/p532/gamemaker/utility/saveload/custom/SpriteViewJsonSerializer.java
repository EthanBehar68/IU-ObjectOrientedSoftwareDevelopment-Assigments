...
public class SpriteViewJsonSerializer extends StdSerializer<SpriteView> {
	private static final long serialVersionUID = -2949327255854395865L;
	...
	/**
	 * Writes the properties of a SpriteView to the JsonGenerator's JSON object.
	 */
	@Override
	public void serialize(SpriteView spriteView, JsonGenerator jsonGenerator, SerializerProvider serializerProvider)
			throws IOException {
	...
	/**
	 * Writes the @type prefix to the JSON object before it is serialized so that
	 * the interface implementor (concrete class) can be identified. Source:
	 * https://stackoverflow.com/a/27893673/16519580
	 */
	@Override
	public void serializeWithType(SpriteView value, JsonGenerator gen, SerializerProvider serializerProvider,
