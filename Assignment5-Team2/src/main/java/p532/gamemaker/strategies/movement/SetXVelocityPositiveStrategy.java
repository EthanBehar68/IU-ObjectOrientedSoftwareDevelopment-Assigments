...
public class SetXVelocityPositiveStrategy implements GeneralStrategy {
	/**
	 * A static strategy that can be used instead of the constructor.
	 */
	public static final SetXVelocityPositiveStrategy instance = new SetXVelocityPositiveStrategy();

	private SetXVelocityPositiveStrategy() {
	}
