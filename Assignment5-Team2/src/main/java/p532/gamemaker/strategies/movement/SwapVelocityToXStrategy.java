...
public class SwapVelocityToXStrategy implements GeneralStrategy {
	/**
	 * A static strategy that can be used instead of the constructor.
	 */
	public static final SwapVelocityToXStrategy instance = new SwapVelocityToXStrategy();

	private SwapVelocityToXStrategy() {
	}
