...
public class SetYVelocityNegativeStrategy implements GeneralStrategy {
	/**
	 * A static strategy that can be used instead of the constructor.
	 */
	public static final SetYVelocityNegativeStrategy instance = new SetYVelocityNegativeStrategy();

	private SetYVelocityNegativeStrategy() {
	}
